...
// 🔹 QUERY SIN id_titular (esa columna no existe en la tabla turnos)
$sqlInsert = "
    INSERT INTO turnos
        (id_paciente, id_afiliado, id_tecnico, id_estudio, 
...
if ($tipo_beneficiario === 'a') {
    ...
    $sqlDatos = "
        ...
        -- Obtener datos del afiliado menor (usar el id_afiliado del turno)
        JOIN afiliados a_menor ON a_menor.id = t.id_afiliado
