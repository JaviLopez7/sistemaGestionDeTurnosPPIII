                ...
                <div class="afiliado-card">
                    ...
                    <?php if (!empty($afiliado['id_paciente'])): ?>
                        <div class="afiliado-actions">
                            <a href="/interfaces/Paciente/Gestion/Turnos-Medico/turnoMedico.php" 
                               class="btn btn-turno">
                                <i class="fas fa-calendar-plus"></i> Solicitar Turno Médico
                            </a>
                            <a href="/interfaces/Paciente/Gestion/Turnos-Estudio/turnoEstudio.php" 
                               class="btn btn-turno">
                                <i class="fas fa-vials"></i> Solicitar Estudio
                            </a>
                            <a href="/interfaces/Paciente/misCredenciales.php" 
