...
function seleccionarAfiliado(afiliado) {
    // id_paciente = ID del titular
    // id_afiliado = ID del beneficiario
    // id_titular = ID del titular
    pacienteActual = afiliado;
    idPacienteInput.value = afiliado.id_titular || '';  // Titular
    idAfiliadoInput.value = afiliado.id;                // Beneficiario menor
    idTitularInput.value = afiliado.id_titular || '';  // Titular
...
if (formNuevaOrden) {
  formNuevaOrden.addEventListener('submit', async (e) => {
    ...
    console.log("id_paciente:", idPacienteInput.value);
    console.log("id_afiliado:", idAfiliadoInput.value);
    console.log("id_titular:", idTitularInput.value);
